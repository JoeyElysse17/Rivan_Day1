...
conf t
 ...
 ip dhcp pool CAMERA6
  host 10.51.50.6 255.255.255.0
  client-identifier #camera6macadd#
 ip dhcp pool CAMERA8
  host 10.51.50.8 255.255.255.0
...
!@CoreTAAS
config t
 hostname CoreTAAS-51-(PLDT)
 Track 1 Int gi 0/1 line-protocol
 int vlan 1
  standby 1 ip 10.51.1.16
  standby 1 preempt
...
conf t
 int tun1
  ip add 172.16.1.51 255.255.255.0
  ...
  no ip nhrp map 172.16.1.51 200.0.0.51
  exit
  !
 no ip access-list extended NAT-POLICY
 ip access-list extended NAT-POLICY
  deny ip 10.51.0.0 0.0.255.255 10.11.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.12.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.21.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.22.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.31.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.32.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.41.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.42.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.51.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.52.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.61.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.62.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.71.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.72.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.81.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.82.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.91.0.0 0.0.255.255
  deny ip 10.51.0.0 0.0.255.255 10.92.0.0 0.0.255.255
  no deny ip 10.51.0.0 0.0.255.255 10.51.0.0 0.0.255.255
  permit ip any any
  exit
 !
 ...
 !
 no ip route 10.51.0.0 255.255.0.0 172.16.1.51 252
 end
~~~ 
...
ifname ens256 \
ipv4.method manual \
ipv4.addresses 10.51.1.6/24 \
autoconnect yes

nmcli connection up BRIDGED

route add 10.0.0.0/8 via 10.51.1.4
route add 200.0.0.0/24 via 10.51.1.4
~~~
...
~~~
!@NetOps
ifconfig ens256 10.51.1.6 netmask 255.255.255.0 up
route add 10.0.0.0/8 via 10.51.1.4
route add 200.0.0.0/24 via 10.51.1.4
~~~
...
~~~
[realdevices]
ctaas ansible_host=10.51.1.2 ansible_user=admin ansible_password=pass
cbaba ansible_host=10.51.1.4 ansible_user=rivan ansible_password=C1sc0123
...
~~~
[real_cisco]
CTAAS ansible_host=10.51.1.2
CBABA ansible_host=10.51.1.4
CUCM ansible_host=10.51.100.8
EDGE ansible_host=10.51.51.1
